...
nmssm_params_extended.update({
    ...
    "mq3": Param(label=r"$M_{Q_3}\ \mathrm{[GeV]}$", color="darksage", bins=25, range=[800, 2500], interval=500),
    "mu3": Param(label=r"$M_{U_3}\ \mathrm{[GeV]}$", color="darksage", bins=25, range=[500, 2500], interval=500),
    "au3": Param(label=r"$A_{t}\ \mathrm{[GeV]}$", color="cyan", bins=25, range=[1500, 5000], interval=1000),
    "md3": Param(label=r"$M_{D_3}\ \mathrm{[GeV]}$", color="purple", bins=25, range=[500, 2500], interval=500),
    "ad3": Param(label=r"$A_{b}\ \mathrm{[GeV]}$", color="purple", bins=25, range=[500, 2500], interval=500),
...
nmssm_params_all.update({
    ...
    "mq3": Param(label=r"$M_{Q_3}$", color="darksage", bins=25, range=[0, 2000], interval=-1),
    "mq2": Param(label=r"$M_{Q_2}$", color="darksage", bins=25, range=[0, 2000], interval=-1),
    "mu3": Param(label=r"$M_{U_3}$", color="darksage", bins=25, range=[0, 2000], interval=-1),
    "mu2": Param(label=r"$M_{U_2}$", color="darksage", bins=25, range=[0, 2000], interval=-1),
    "md3": Param(label=r"$M_{D_3}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "md2": Param(label=r"$M_{D_2}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "au3": Param(label=r"$A_{t}$", color="cyan", bins=25, range=[0, 2000], interval=-1),
    "ad3": Param(label=r"$A_{b}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "ml3": Param(label=r"$M_{L_3}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "ml2": Param(label=r"$M_{L_2}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "me3": Param(label=r"$M_{E_3}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "me2": Param(label=r"$M_{E_2}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "ae3": Param(label=r"$A_{E_3}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    "ae2": Param(label=r"$A_{E_2}$", color="purple", bins=25, range=[0, 2000], interval=-1),
    # "m0": Param(label=r"$M0$", color="purple", bins=25, range=[0, 2000], interval=-1),
    # "m12": Param(label=r"$M12$", color="purple", bins=25, range=[0, 2000], interval=-1),
})
